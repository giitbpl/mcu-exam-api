    ...
    update(records, tablename) {
        let pro = new Promise((resolve, reject) => {
            async.forEachOf(records, (data, key, callback) => {
                ...
                {
                courseService.update(data, "course_16").then(result => {
                    console.log("course_16=>", result.affectedRows);
                    if (result.affectedRows == 0) {
                        courseService.update(data, "course_17").then(r1 => {
                      //      console.log("course_17=>", r1.affectedRows);

                            if (r1.affectedRows == 0) {

                                courseService.update(data, "course_14").then(r2 => {
                        //            console.log("course_14=>", r2.affectedRows);

                                    if (r2.affectedRows == 0) {
                                        courseService.update(data, "course_media").then(r3 => {
                           //                 console.log("course_media=>", r3.affectedRows);
