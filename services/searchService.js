        ...
        let p = new Promise((resolve, reject) => {
            connection.getConnection(async (err, conn) => {
                ...
                if (err) reject(err);
                    ...
                    let sql = "SELECT A.*,B.`COLLEGE / CENTER NAME`,B.city,B.dist FROM " + tablename + " as A LEFT JOIN " + tablename2 + " as B on A.examcent=B.code where A.enrollno=? and A.yrtermcode=? and SUBSTRING(A.examcode2, CHARACTER_LENGTH(A.examcode2)-1, 1)=?";
